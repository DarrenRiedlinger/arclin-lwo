...
SITE_NAME = 'arclinlwo-tool'
SITE_DOMAIN = 'www.lwo.arclin.com'
...
MEDIA_ROOT = '/webapps/arclinlwo_proj/media/'
...
STATIC_ROOT = '/webapps/arclinlwo_proj/static/'
...
ROOT_URLCONF = 'arclinlwo_proj.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'arclinlwo_proj.wsgi.application'
